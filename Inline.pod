...
If C<Inline> works on your Unix platform, please email me the info above. If it doesn't work, see L<BUGS AND DEFICIENCIES> below.

I would like to port this to Win32 as soon as possible, but that's a big step for me. Any takers?
